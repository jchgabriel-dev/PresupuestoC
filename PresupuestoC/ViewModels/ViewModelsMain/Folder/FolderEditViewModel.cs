...
{
    public class FolderEditViewModel : ViewModelBase, INotifyDataErrorInfo
    {
        ...
        public ICommand EditFolder { get; } 

        // CONSTRUCTOR
        public FolderEditViewModel(CloseNavigationService close, FolderListStore store, FolderSelectedStore selected)
        {
            CloseModal = new CloseNavigateCommand(close);
            EditFolder = new FolderEditCommand(this, close, store, selected);
